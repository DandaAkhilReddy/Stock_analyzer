    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <Card>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h4 className="text-sm font-medium text-emerald-400">Bull Case</h4>
        </div>
        <p className="text-sm text-gray-300 leading-relaxed">{analysis.bull_case}</p>
      </Card>
      ...
      <Card>
        ...
        <p className="text-sm text-gray-300 leading-relaxed">{analysis.bear_case}</p>
      </Card>
    </div>
  );
}
